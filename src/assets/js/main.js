...
; (function ($) {
    ...
    if($('.body').hasClass('is_dark')) {
        if ($('#logo_header').length) {document.getElementById("logo_header").src = "assets/images/logo.png";}
        ...
        function responsivemenu(mobile) {
          if (mobile.matches) {
            $("#main-nav")
              ...
              var main_nav = $("#main-nav-mobi");
              $("#main-nav-mobi .menu-item  a").click(function(){
                  $("#main-nav-mobi").slideUp();
